...
- [x] Move to HttpGuzzle
- [x] Changes due to new Instagram API
- [x] More flexible requests (method params)
- [ ] Make tests! 
- [ ] Add `getMediaShortcode()` endpoint
- [ ] Update Instagram icon for V3
